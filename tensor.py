...
class Tensor:
    ...
    which builds up a 'directed acyclic computation graph'
    (DAG). This allows differentiation of 0-dimensional Tensors
...
def tensor_add(t1:'Tensor', t2:'Tensor') -> 'Tensor':
    ...
    def grad_func() -> None:
        ...
        of t1 and t2:
            ...
            t1 affects a change of dx in n entries of t2. As a consequence,
            after the resulting Tensor gets fed into f, a change of dx in an entry
            of t1 results in a change of n*dx in f.
